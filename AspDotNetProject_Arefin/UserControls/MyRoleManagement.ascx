<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MyRoleManagement.ascx.cs" Inherits="AspDotNetProject_Arefin.UserControls.MyRoleManagement" %>
<br /><br />

    <h2>Manage User And Roles</h2>
    (Only Users associated with the Admin Role access this page)
    <br /><br />
    ...
    <div class="row">
        <div class="col-sm-12 table-responsive">
            ...
            <asp:GridView ID="grdUsers" runat="server" DataKeyNames="Id"
                ...
                ItemType="AspDotNetProject_Arefin.Models.ApplicationUser" 
        ...
        <div class="col-sm-6">
            <asp:DetailsView ID="dvUsers" runat="server" DataKeyNames="Id" 
                ...
                InsertMethod="dvUsers_InsertItem" DeleteMethod="dvUsers_DeleteItem" OnPageIndexChanging="dvUsers_PageIndexChanging">
                <Fields>
                    <asp:BoundField HeaderText="Email" DataField="Email" />
